...
class QuaggaTopo(Topo):
	...
	R4 = QuaggaHost(name='r4', ip='172.0.6.1/24', loIP='10.0.6.1/24')
	...
	self.addLink(quaggaNodes[4],quaggaNodes[3], intfName1='r2-eth1', params1={'ip':'172.0.4.1/24'}, intfName2='r4-eth2', params2={'ip':'172.0.4.2/24'})
	...
	self.addLink(quaggaNodes[2],quaggaNodes[3], intfName1='h2-eth0', params1={'ip':'172.0.6.2/24'}, intfName2='r4-eth0', params2={'ip':'172.0.6.1/24'})
